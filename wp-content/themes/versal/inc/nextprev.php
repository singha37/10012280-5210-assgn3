...
<div id="post-nav">
    ...
    ?>
        <div class="post-previous tranz">
            ...
            <a class="post-nav-text ghost boxshadow" href="<?php the_permalink(); ?>"><?php esc_html_e('Previous Story','versal');?>:<br/> <strong><?php the_title(); ?></strong></a>
        </div>
    <?php
                wp_reset_postdata();
            } //end foreach
    ...
    ?>
        <div class="post-next tranz">
            ...
            <a class="post-nav-text ghost tranz boxshadow" href="<?php the_permalink(); ?>"><?php esc_html_e('Next Story','versal');?>:<br/> <strong><?php the_title(); ?></strong></a>
        </div>
    <?php
                wp_reset_postdata();
            } //end foreach
