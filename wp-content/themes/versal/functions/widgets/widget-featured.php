<?php
add_action('widgets_init', 'versal_featured_widget');

function versal_featured_widget()
{
	register_widget('versal_featured_widget');
}

class versal_featured_widget extends WP_Widget {
	
	public function __construct() {
		$widget_ops = array('classname' => 'versal_featured_widget', 'description' => esc_html__('Featured posts widget.','versal'));
       	parent::__construct('versal_feat', esc_html__('Vergo - Featured','versal'),$widget_ops);  
	}
		...
		?>
            ...
            <ul class="featured featured_big">
                ...
                ?>
                	...
                	<li><?php get_template_part('/post-types/tab-post'); ?></li>
                
                <?php else: ?>
                
                	<li><?php get_template_part('/post-types/tab-post-small'); ?></li>
